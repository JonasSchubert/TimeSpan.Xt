...
namespace TimeSpanXt
{
  ...
  public static partial class NumberExtensions
  {
    ...
    public static TimeSpan Years(this sbyte value, bool accumulated = false) => FluentTimeSpan.FromYears(value, accumulated);
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan Years(this byte value, bool accumulated = false) => FluentTimeSpan.FromYears(value, accumulated);
