...
namespace TimeSpanXt
{
  ...
  public static partial class FluentTimeSpan
  {
    ...
    public static double InCenturies(this TimeSpan timeSpan, bool accumulated = false)
    {
      return (double)timeSpan.Ticks / (accumulated ? TicksPerCenturyAccumulated : TicksPerCentury);
    }
    ...
    public static double InDecades(this TimeSpan timeSpan, bool accumulated = false)
    {
      return (double)timeSpan.Ticks / (accumulated ? TicksPerDecadeAccumulated : TicksPerDecade);
    }
    ...
    public static double InYears(this TimeSpan timeSpan, bool accumulated = false)
    {
      return (double)timeSpan.Ticks / (accumulated ? TicksPerYearAccumulated : TicksPerYear);
    }
