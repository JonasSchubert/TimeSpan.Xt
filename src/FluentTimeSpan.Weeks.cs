...
namespace TimeSpanXt
{
  ...
  public static partial class FluentTimeSpan
  {
    ...
    public static TimeSpan FromWeeks(sbyte value) => new TimeSpan(TicksPerWeek * value);
    ...
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromWeeks(byte value) => new TimeSpan(TicksPerWeek * value);
