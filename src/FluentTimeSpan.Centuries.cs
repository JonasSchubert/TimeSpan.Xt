...
namespace TimeSpanXt
{
  ...
  public static partial class FluentTimeSpan
  {
    ...
    public static TimeSpan FromCenturies(sbyte value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(byte value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(decimal value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(double value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(float value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(int value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(long value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(short value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(uint value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(ulong value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * (long)value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromCenturies(ushort value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerCenturyAccumulated : TicksPerCentury) * value);
    }
  }
