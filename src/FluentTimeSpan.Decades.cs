...
namespace TimeSpanXt
{
  ...
  public static partial class FluentTimeSpan
  {
    ...
    public static TimeSpan FromDecades(sbyte value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(byte value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(decimal value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(double value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(float value, bool accumulated = false)
    {
      return new TimeSpan((long)((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value));
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(int value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(long value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(short value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(uint value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(ulong value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * (long)value);
    }
    ...
    /// <param name="accumulated">If set to true, returns the accumulated value. Accumulated values include leap years.</param>
    /// <returns>The Timespan.</returns>
    public static TimeSpan FromDecades(ushort value, bool accumulated = false)
    {
      return new TimeSpan((accumulated ? TicksPerDecadeAccumulated : TicksPerDecade) * value);
    }
  }
